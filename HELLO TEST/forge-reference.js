/* ═══ @module FORGE v2.0 · contract: SPEC §5 · deps: none (THREE, VG injected) ═══
   ...
   language whose runtime is VG and whose one export is build(g, VG, THREE).
...
(function (root, factory) {
  ...
  // Entry-generalized compiler: world and AI-builder code use the same Forge
  // pipeline as vehicles, but the called symbol and argument list are explicit.
